...
This file provides guidance to Claude Code or Gemini when working with code in this repository.
...
## Cleaning
Clear the links.txt file once the new links have been added to the repo

## Self-improvement
- update @AGENTS.md in this folder before committing, if during the current conversation you have learned something that could ease the process next time
